...
<div class="container-fluid">
              ...
              <tbody>
                <?php if ($monthly_stats): ?>
                  ...
                  <tr>
                    ...
                    <td><?= number_format($day['uptime_percent'],2) ?>%</td>
                    <td class="<?= $sc ?>"><?= $st ?></td>
                  </tr>
                  <?php endforeach; ?>
                  <!-- Add monthly total/average row -->
                  <tr class="table-primary fw-bold">
                    ...
                    <td><?= $monthly_total['total_offline_count'] ?></td>
                    <td><?= $monthly_total['total_checks'] ?></td>
                    <td><?= number_format($monthly_total['avg_uptime_percent'],2) ?>%</td>
                    <td class="<?php 
  ...
  <div class="card mb-4 shadow-sm">
    ...
    <div class="card-body">
      ...
      <div class="mb-3">
        <div class="btn-group">
          <a href="?report=<?= $report_id ?>&month=4&view_mode=all" class="btn btn-sm <?= $viewMode == 'all' ? 'btn-primary' : 'btn-outline-primary' ?>">
            <i class="fas fa-calendar-alt"></i> All April Data
          </a>
